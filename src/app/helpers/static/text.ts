export const TEXT_PRINT = 'Imprimmer la liste de mes commissions disponibles à annexer à votre facture';
export const TEXT_INFO_PANEL = [0, 1, 2, 3, 4, 5].map(v => 'Les commissions doivent être expréssement demandées lors de chaque commande.');
